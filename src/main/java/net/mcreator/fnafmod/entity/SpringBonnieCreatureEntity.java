...
import net.mcreator.fnafmod.entity.renderer.SpringBonnieCreatureRenderer;
import net.mcreator.fnafmod.FnafModModElements;

@FnafModModElements.ModElement.Tag
public class SpringBonnieCreatureEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("spring_bonnie_creature").setRegistryName("spring_bonnie_creature");
	public SpringBonnieCreatureEntity(FnafModModElements instance) {
		super(instance, 123);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SpringBonnieCreatureRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("spring_bonnie_creature_spawn_egg"));
	}
