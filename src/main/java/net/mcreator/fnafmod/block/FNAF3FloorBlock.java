...
public class FNAF3FloorBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_3_floor")
	public static final Block block = null;
	public FNAF3FloorBlock(FnafModModElements instance) {
		super(instance, 133);
	}
