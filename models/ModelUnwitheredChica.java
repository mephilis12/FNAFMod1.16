...
public static class ModelUnwitheredChica extends EntityModel<Entity> {
	...
	public ModelUnwitheredChica() {
		...
		Head.setTextureOffset(36, 49).addBox(-2.0F, -2.5F, -6.8F, 4.0F, 1.0F, 1.0F, -0.1F, false);
		...
		Head.setTextureOffset(116, 46).addBox(-1.0F, -4.0F, -6.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		Head.setTextureOffset(114, 42).addBox(-2.0F, -3.0F, -7.0F, 4.0F, 1.0F, 3.0F, 0.0F, false);
		Head.setTextureOffset(113, 54).addBox(-1.5F, -11.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		Head.setTextureOffset(117, 51).addBox(-1.0F, -10.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
