...
import net.mcreator.fnafmod.entity.renderer.PassiveChicaRenderer;
...
public class PassiveChicaEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("passive_chica").setRegistryName("passive_chica");
	public PassiveChicaEntity(FnafModModElements instance) {
		super(instance, 162);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PassiveChicaRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -9682156, -16777216, new Item.Properties().group(null)).setRegistryName("passive_chica_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ChicaItem.block, (int) (1)));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				PassiveChicaOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
