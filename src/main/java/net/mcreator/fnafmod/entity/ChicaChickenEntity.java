...
import net.mcreator.fnafmod.procedures.ChicaChickenOnInitialEntitySpawnProcedure;
...
public class ChicaChickenEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("chica_chicken").setRegistryName("chica_chicken");
	public ChicaChickenEntity(FnafModModElements instance) {
		super(instance, 64);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ChicaChickenRenderer.ModelRegisterHandler());
