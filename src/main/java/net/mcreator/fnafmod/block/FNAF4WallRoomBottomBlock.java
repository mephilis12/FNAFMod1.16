...
public class FNAF4WallRoomBottomBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_4_wall_room_bottom")
	public static final Block block = null;
	public FNAF4WallRoomBottomBlock(FnafModModElements instance) {
		super(instance, 338);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fnaf_4_wall_room_bottom");
		}
