...
public class WhiteBlackWallTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:white_black_wall_tile")
	public static final Block block = null;
	public WhiteBlackWallTileBlock(FnafModModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_black_wall_tile");
		}
