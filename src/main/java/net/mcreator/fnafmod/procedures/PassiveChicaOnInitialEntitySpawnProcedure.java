...
public class PassiveChicaOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public PassiveChicaOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 225);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure PassiveChicaOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure PassiveChicaOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof PassiveChicaEntity.CustomEntity)) {
