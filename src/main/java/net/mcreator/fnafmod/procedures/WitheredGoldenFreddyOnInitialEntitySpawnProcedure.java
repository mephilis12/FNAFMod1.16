...
public class WitheredGoldenFreddyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public WitheredGoldenFreddyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 234);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure WitheredGoldenFreddyOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure WitheredGoldenFreddyOnInitialEntitySpawn!");
			return;
		}
