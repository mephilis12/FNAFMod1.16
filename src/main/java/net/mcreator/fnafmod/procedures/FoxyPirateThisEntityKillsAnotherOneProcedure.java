...
public class FoxyPirateThisEntityKillsAnotherOneProcedure extends FnafModModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		new Object() {
			...
			private void run() {
				FnafModModVariables.WorldVariables.get(world).FoxyFrame1 = (boolean) (true);
				...
				new Object() {
					...
					private void run() {
						FnafModModVariables.WorldVariables.get(world).FoxyFrame1 = (boolean) (false);
						FnafModModVariables.WorldVariables.get(world).syncData(world);
				...
				new Object() {
					...
					private void run() {
						FnafModModVariables.WorldVariables.get(world).FoxyFrame2 = (boolean) (true);
						FnafModModVariables.WorldVariables.get(world).syncData(world);
						new Object() {
							private int ticks = 0;
							private float waitTicks;
							...
							private void run() {
								FnafModModVariables.WorldVariables.get(world).FoxyFrame2 = (boolean) (false);
								FnafModModVariables.WorldVariables.get(world).syncData(world);
								MinecraftForge.EVENT_BUS.unregister(this);
							}
						}.start(world, (int) 0.1);
						new Object() {
							...
							private void run() {
								FnafModModVariables.WorldVariables.get(world).FoxyFrame3 = (boolean) (true);
								FnafModModVariables.WorldVariables.get(world).syncData(world);
								new Object() {
									private int ticks = 0;
									private float waitTicks;
									...
									private void run() {
										FnafModModVariables.WorldVariables.get(world).FoxyFrame3 = (boolean) (false);
										FnafModModVariables.WorldVariables.get(world).syncData(world);
										MinecraftForge.EVENT_BUS.unregister(this);
									}
								}.start(world, (int) 0.1);
								new Object() {
									...
									private void run() {
										FnafModModVariables.WorldVariables.get(world).FoxyFrame4 = (boolean) (true);
										FnafModModVariables.WorldVariables.get(world).syncData(world);
										new Object() {
											private int ticks = 0;
											private float waitTicks;
											...
											private void run() {
												FnafModModVariables.WorldVariables.get(world).FoxyFrame4 = (boolean) (false);
												FnafModModVariables.WorldVariables.get(world).syncData(world);
												MinecraftForge.EVENT_BUS.unregister(this);
											}
										}.start(world, (int) 0.1);
										new Object() {
											...
											private void run() {
												FnafModModVariables.WorldVariables.get(world).FoxyFrame5 = (boolean) (true);
												FnafModModVariables.WorldVariables.get(world).syncData(world);
												new Object() {
													private int ticks = 0;
													private float waitTicks;
													...
													private void run() {
														FnafModModVariables.WorldVariables.get(world).FoxyFrame5 = (boolean) (false);
														FnafModModVariables.WorldVariables.get(world).syncData(world);
														MinecraftForge.EVENT_BUS.unregister(this);
													}
												}.start(world, (int) 0.1);
																...
																new Object() {
																	...
																	private void run() {
																		...
																		new Object() {
																			...
																			private void run() {
																				FnafModModVariables.WorldVariables
																						.get(world).FoxyFrame3 = (boolean) (false);
																				FnafModModVariables.WorldVariables.get(world).syncData(world);
																				MinecraftForge.EVENT_BUS.unregister(this);
																			}
																		}.start(world, (int) 0.1);
																		new Object() {
																			...
																			private void run() {
																				FnafModModVariables.WorldVariables
																						.get(world).FoxyFrame4 = (boolean) (true);
																				FnafModModVariables.WorldVariables.get(world).syncData(world);
																				new Object() {
																					private int ticks = 0;
																					private float waitTicks;
																					...
																					private void run() {
																						FnafModModVariables.WorldVariables
																								.get(world).FoxyFrame4 = (boolean) (false);
																						FnafModModVariables.WorldVariables.get(world).syncData(world);
																						MinecraftForge.EVENT_BUS.unregister(this);
																					}
																				}.start(world, (int) 0.1);
																				new Object() {
																					...
																					private void run() {
																						FnafModModVariables.WorldVariables
																								.get(world).FoxyFrame5 = (boolean) (true);
																						FnafModModVariables.WorldVariables.get(world).syncData(world);
																						new Object() {
																							private int ticks = 0;
																							private float waitTicks;
																							...
																							private void run() {
																								FnafModModVariables.WorldVariables
																										.get(world).FoxyFrame5 = (boolean) (false);
