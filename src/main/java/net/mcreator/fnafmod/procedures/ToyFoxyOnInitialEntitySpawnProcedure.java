...
public class ToyFoxyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public ToyFoxyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 304);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure ToyFoxyOnInitialEntitySpawn!");
			return;
		}
		...
		if ((entity instanceof ToyFoxyEntity.CustomEntity)) {
