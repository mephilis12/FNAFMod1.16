...
public class MangleSittingOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public MangleSittingOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 283);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure MangleSittingOnInitialEntitySpawn!");
			return;
		}
