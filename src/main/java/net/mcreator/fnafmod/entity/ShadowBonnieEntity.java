...
public class ShadowBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("shadow_bonnie").setRegistryName("shadow_bonnie");
	public ShadowBonnieEntity(FnafModModElements instance) {
		super(instance, 229);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16056302, -15794150, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("shadow_bonnie_spawn_egg"));
	}
