...
@OnlyIn(Dist.CLIENT)
public class NightimeToyChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NightimeToyChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelToy_Chica(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/night_toy_chica.png");
					}
				};
			});
		}
