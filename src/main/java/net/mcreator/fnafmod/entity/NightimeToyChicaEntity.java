...
public class NightimeToyChicaEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("nightime_toy_chica").setRegistryName("nightime_toy_chica");
	public NightimeToyChicaEntity(FnafModModElements instance) {
		super(instance, 272);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NightimeToyChicaRenderer.ModelRegisterHandler());
