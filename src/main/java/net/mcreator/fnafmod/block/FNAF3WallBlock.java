...
public class FNAF3WallBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_3_wall")
	public static final Block block = null;
	public FNAF3WallBlock(FnafModModElements instance) {
		super(instance, 134);
	}
