...
public class SittingSpringBonnieOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public SittingSpringBonnieOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 218);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure SittingSpringBonnieOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure SittingSpringBonnieOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof SittingSpringBonnieEntity.CustomEntity)) {
