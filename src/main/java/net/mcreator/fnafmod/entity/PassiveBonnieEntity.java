...
import net.mcreator.fnafmod.entity.renderer.PassiveBonnieRenderer;
...
public class PassiveBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("passive_bonnie").setRegistryName("passive_bonnie");
	public PassiveBonnieEntity(FnafModModElements instance) {
		super(instance, 160);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PassiveBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -9682156, -16777216, new Item.Properties().group(null)).setRegistryName("passive_bonnie_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BonnieItem.block, (int) (1)));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				PassiveBonnieOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
