...
import net.mcreator.fnafmod.entity.renderer.PassiveFredbearRenderer;
...
public class PassiveFredbearEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("passive_fredbear").setRegistryName("passive_fredbear");
	public PassiveFredbearEntity(FnafModModElements instance) {
		super(instance, 159);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PassiveFredbearRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -9682156, -16777216, new Item.Properties().group(null)).setRegistryName("passive_fredbear_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FredbearItemItem.block, (int) (1)));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				PassiveFredbearOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
