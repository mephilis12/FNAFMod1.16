...
public class ChicaChickenThisEntityKillsAnotherOneProcedure extends FnafModModElements.ModElement {
	public ChicaChickenThisEntityKillsAnotherOneProcedure(FnafModModElements instance) {
		super(instance, 120);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FnafModMod.LOGGER.warn("Failed to load dependency y for procedure ChicaChickenThisEntityKillsAnotherOne!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FnafModMod.LOGGER.warn("Failed to load dependency z for procedure ChicaChickenThisEntityKillsAnotherOne!");
			return;
		}
