...
import net.mcreator.fnafmod.procedures.BonnieBunnyOnInitialEntitySpawnProcedure;
...
public class BonnieBunnyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("bonnie_bunny").setRegistryName("bonnie_bunny");
	public BonnieBunnyEntity(FnafModModElements instance) {
		super(instance, 63);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BonnieBunnyRenderer.ModelRegisterHandler());
