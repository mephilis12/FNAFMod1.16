...
public class OfficeDoorBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:office_door")
	public static final Block block = null;
	public OfficeDoorBlock(FnafModModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(SecurityDoorOpenBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SecurityDoorOpenBlock.block));
		}
