...
public class MangleEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("mangle").setRegistryName("mangle");
	public MangleEntity(FnafModModElements instance) {
		super(instance, 205);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1776412, -449623, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("mangle_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				MangleOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MangleOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
