...
public class Pizzeria1Structure extends FnafModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pizzeria_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fnaf_mod:pizzeria_1"), configuredFeature);
		}
	}
	@SubscribeEvent
