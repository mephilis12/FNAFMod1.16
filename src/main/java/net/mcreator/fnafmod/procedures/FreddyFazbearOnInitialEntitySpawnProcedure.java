...
public class FreddyFazbearOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public FreddyFazbearOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 213);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure FreddyFazbearOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure FreddyFazbearOnInitialEntitySpawn!");
			return;
		}
