...
public static class ModelUnwitheredFoxy extends EntityModel<Entity> {
	...
	public ModelUnwitheredFoxy() {
		...
		Jaw.setTextureOffset(95, 41).addBox(-2.0F, -0.5F, -8.5F, 4.0F, 2.0F, 5.0F, -0.1F, false);
		...
		LeftLeg.setTextureOffset(20, 47).addBox(-6.5F, 10.0F, -2.5F, 5.0F, 2.0F, 2.0F, 0.0F, false);
		...
		RightLeg.setTextureOffset(20, 47).addBox(1.5F, 10.0F, -2.5F, 5.0F, 2.0F, 2.0F, 0.0F, false);
	}
