...
public class RedBlueTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:red_blue_tile")
	public static final Block block = null;
	public RedBlueTileBlock(FnafModModElements instance) {
		super(instance, 3);
	}
