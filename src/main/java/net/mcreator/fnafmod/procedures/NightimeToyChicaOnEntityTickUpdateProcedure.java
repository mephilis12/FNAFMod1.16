	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FnafModMod.LOGGER.warn("Failed to load dependency x for procedure NightimeToyChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FnafModMod.LOGGER.warn("Failed to load dependency y for procedure NightimeToyChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FnafModMod.LOGGER.warn("Failed to load dependency z for procedure NightimeToyChicaOnEntityTickUpdate!");
			return;
		}
			...
			if (((entity.getPersistentData().getDouble("FNAFTimer")) == 0)) {
				if ((entity instanceof NightimeToyChicaEntity.CustomEntity)) {
					...
					if (world instanceof ServerWorld) {
						Entity entityToSpawn = new ToyChicaEntity.CustomEntity(ToyChicaEntity.entity, (World) world);
