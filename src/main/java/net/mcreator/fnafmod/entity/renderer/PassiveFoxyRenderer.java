...
@OnlyIn(Dist.CLIENT)
public class PassiveFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PassiveFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFoxy(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/foxytexture.png");
					}
				};
			});
		}
	...
	public static class ModelFoxy extends EntityModel<Entity> {
		...
		public ModelFoxy() {
			...
			Body.setTextureOffset(63, 0).addBox(4.0F, -14.2F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
			Body.setTextureOffset(63, 5).addBox(-7.0F, -14.2F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
			...
			Body.addChild(Head);
			Head.setTextureOffset(34, 48).addBox(-1.5F, -2.5F, -7.8F, 3.0F, 1.0F, 4.0F, 0.0F, false);
			Head.setTextureOffset(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 6.0F, 8.0F, 0.0F, false);
			Head.setTextureOffset(98, 0).addBox(-5.5F, -4.0F, -4.3F, 11.0F, 2.0F, 4.0F, 0.0F, false);
			Head.setTextureOffset(40, 0).addBox(-4.0F, -2.0F, 1.0F, 8.0F, 1.0F, 3.0F, 0.0F, false);
			Head.setTextureOffset(67, 39).addBox(-2.0F, -4.0F, -8.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);
			Head.setTextureOffset(58, 15).addBox(-1.0F, -4.5F, -8.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			...
			Head.setTextureOffset(63, 18).addBox(-4.1F, -7.0F, -4.5F, 3.0F, 3.0F, 9.0F, 0.0F, false);
			Head.setTextureOffset(83, 59).addBox(3.0F, -12.0F, -1.0F, 3.0F, 5.0F, 1.0F, 0.0F, false);
			Head.setTextureOffset(75, 59).addBox(-6.0F, -12.0F, -1.0F, 3.0F, 5.0F, 1.0F, 0.0F, false);
			Head.setTextureOffset(42, 35).addBox(-1.0F, -9.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
			Head.setTextureOffset(43, 39).addBox(-1.5F, -10.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
			...
			Patch.setRotationPoint(-2.0F, -6.0F, -4.0F);
			Head.addChild(Patch);
			Patch.setTextureOffset(63, 31).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 2.0F, 0.0F, 0.0F, false);
			...
			RightArm.setTextureOffset(26, 30).addBox(-2.01F, -2.0F, -1.5F, 3.0F, 13.0F, 3.0F, 0.0F, false);
			...
			LeftLeg.setTextureOffset(0, 46).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 13.0F, 3.0F, 0.0F, false);
			...
			RightLeg.setTextureOffset(32, 12).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 13.0F, 3.0F, 0.0F, false);
		}
