...
public class BlackWhiteTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:black_white_tile")
	public static final Block block = null;
	public BlackWhiteTileBlock(FnafModModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_white_tile");
		}
