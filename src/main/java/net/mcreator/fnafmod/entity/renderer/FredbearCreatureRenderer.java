...
@OnlyIn(Dist.CLIENT)
public class FredbearCreatureRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FredbearCreatureEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFredbear(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/fredbeartexture.png");
					}
				};
			});
		}
	...
	public static class ModelFredbear extends EntityModel<Entity> {
		...
		public ModelFredbear() {
			...
			Head.setTextureOffset(38, 5).addBox(-4.5F, -4.0F, -4.3F, 9.0F, 2.0F, 3.0F, -0.2F, false);
