...
@OnlyIn(Dist.CLIENT)
public class WitheredFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WitheredFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWitheredFoxy(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/witheredfoxywool.png");
					}
				};
			});
		}
