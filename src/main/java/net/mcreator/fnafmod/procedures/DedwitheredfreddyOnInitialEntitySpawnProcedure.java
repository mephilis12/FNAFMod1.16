...
public class DedwitheredfreddyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public DedwitheredfreddyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 302);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure DedwitheredfreddyOnInitialEntitySpawn!");
			return;
		}
