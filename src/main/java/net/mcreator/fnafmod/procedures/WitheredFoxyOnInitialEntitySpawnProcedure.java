...
public class WitheredFoxyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public WitheredFoxyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 232);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure WitheredFoxyOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure WitheredFoxyOnInitialEntitySpawn!");
			return;
		}
