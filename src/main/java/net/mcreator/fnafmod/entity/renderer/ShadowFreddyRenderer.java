...
@OnlyIn(Dist.CLIENT)
public class ShadowFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ShadowFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWitheredGoldenFreddy(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/shadowfreddywool.png");
					}
				};
			});
		}
