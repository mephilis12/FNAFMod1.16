...
public class NightimeToyChicaOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public NightimeToyChicaOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 297);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure NightimeToyChicaOnInitialEntitySpawn!");
			return;
		}
