...
public class PurpleFanBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:purple_fan")
	public static final Block block = null;
	public PurpleFanBlock(FnafModModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1.2f, 10f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("purple_fan");
		}
