...
@OnlyIn(Dist.CLIENT)
public class ToyFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ToyFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelToy_Freddy(), 0.5f) {
					@Override
