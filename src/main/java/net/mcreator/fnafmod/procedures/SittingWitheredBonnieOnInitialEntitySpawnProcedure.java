...
public class SittingWitheredBonnieOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public SittingWitheredBonnieOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 301);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure SittingWitheredBonnieOnInitialEntitySpawn!");
			return;
		}
