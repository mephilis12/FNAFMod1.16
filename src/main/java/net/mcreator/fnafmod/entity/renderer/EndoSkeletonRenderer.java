...
@OnlyIn(Dist.CLIENT)
public class EndoSkeletonRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EndoSkeletonEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelEndo(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/endo.png");
					}
				};
			});
		}
