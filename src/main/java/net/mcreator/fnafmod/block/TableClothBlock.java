...
public class TableClothBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:table_cloth")
	public static final Block block = null;
	public TableClothBlock(FnafModModElements instance) {
		super(instance, 10);
	}
