...
public class CircuitBoardItem extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:circuit_board")
	public static final Item block = null;
	public CircuitBoardItem(FnafModModElements instance) {
		super(instance, 98);
	}
