...
@OnlyIn(Dist.CLIENT)
public class SittingWitheredChicaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SittingWitheredChicaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSittingWitheredChica(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/witheredchicawool.png");
					}
				};
			});
		}
