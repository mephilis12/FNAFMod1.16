...
public class WitheredBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("withered_bonnie").setRegistryName("withered_bonnie");
	public WitheredBonnieEntity(FnafModModElements instance) {
		super(instance, 200);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10998651, -52480, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("withered_bonnie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				WitheredBonnieOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
