...
public class ToyChicaEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("toy_chica").setRegistryName("toy_chica");
	public ToyChicaEntity(FnafModModElements instance) {
		super(instance, 209);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1055193, -38689, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("toy_chica_spawn_egg"));
	}
