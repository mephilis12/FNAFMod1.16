...
@OnlyIn(Dist.CLIENT)
public class DedwitheredfreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DedwitheredfreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModeldedWitheredFreddy(), 0.5f) {
					@Override
	...
	public static class ModeldedWitheredFreddy extends EntityModel<Entity> {
		...
		public ModeldedWitheredFreddy() {
			...
			Body.addChild(Head);
			setRotationAngle(Head, 0.0F, 0.2182F, 0.0F);
			...
			setRotationAngle(RightArm, 0.0873F, 0.0F, 0.2182F);
			...
			setRotationAngle(LeftLeg, 0.0436F, 0.0F, -0.1745F);
			...
			setRotationAngle(RightLeg, 0.0873F, 0.0F, 0.1309F);
