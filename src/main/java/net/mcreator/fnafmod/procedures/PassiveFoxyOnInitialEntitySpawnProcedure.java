...
public class PassiveFoxyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public PassiveFoxyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 226);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure PassiveFoxyOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure PassiveFoxyOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof PassiveFoxyEntity.CustomEntity)) {
