...
@OnlyIn(Dist.CLIENT)
public class ToyFoxyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ToyFoxyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelToy_Foxy(), 0.5f) {
					@Override
