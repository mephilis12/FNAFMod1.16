...
public class PassiveSpringBonnieOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public PassiveSpringBonnieOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 224);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure PassiveSpringBonnieOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure PassiveSpringBonnieOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof PassiveSpringBonnieEntity.CustomEntity)) {
