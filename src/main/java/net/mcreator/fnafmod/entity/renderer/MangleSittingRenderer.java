...
@OnlyIn(Dist.CLIENT)
public class MangleSittingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MangleSittingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMangleDown(), 0.5f) {
					@Override
