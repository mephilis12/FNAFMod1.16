...
public class PurpleGuyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public PurpleGuyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 299);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure PurpleGuyOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if ((entity instanceof PurpleGuyEntity.CustomEntity)) {
