...
import net.mcreator.fnafmod.entity.renderer.WitheredFreddyRenderer;
...
public class WitheredFreddyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("withered_freddy").setRegistryName("withered_freddy");
	public WitheredFreddyEntity(FnafModModElements instance) {
		super(instance, 201);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WitheredFreddyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9682156, -1272206, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("withered_freddy_spawn_egg"));
	}
