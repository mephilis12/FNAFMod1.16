...
import net.mcreator.fnafmod.entity.renderer.ToyFoxyRenderer;
...
public class ToyFoxyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("toy_foxy").setRegistryName("toy_foxy");
	public ToyFoxyEntity(FnafModModElements instance) {
		super(instance, 246);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ToyFoxyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1315861, -52225, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("toy_foxy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ToyFoxyEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				FoxyPirateOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("world", world);
				FoxyPirateThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
