...
import net.mcreator.fnafmod.procedures.PurpleGuyThisEntityKillsAnotherOneProcedure;
import net.mcreator.fnafmod.procedures.PurpleGuyOnInitialEntitySpawnProcedure;
...
import net.mcreator.fnafmod.entity.renderer.PurpleGuyRenderer;
...
public class PurpleGuyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.9f, 0.9f)).build("purple_guy").setRegistryName("purple_guy");
	public PurpleGuyEntity(FnafModModElements instance) {
		super(instance, 298);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14942183, -3355648, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("purple_guy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new WaterAvoidingRandomWalkingGoal(this, 0));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				PurpleGuyOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				PurpleGuyThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
