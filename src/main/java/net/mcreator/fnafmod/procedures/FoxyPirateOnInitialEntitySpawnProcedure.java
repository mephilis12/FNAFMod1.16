...
public class FoxyPirateOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public FoxyPirateOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 217);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure FoxyPirateOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure FoxyPirateOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof FoxyPirateEntity.CustomEntity)) {
