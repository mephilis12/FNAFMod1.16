...
public class WitheredBonnieOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public WitheredBonnieOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 230);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure WitheredBonnieOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure WitheredBonnieOnInitialEntitySpawn!");
			return;
		}
