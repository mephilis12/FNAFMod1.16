...
public class ClosetRightBottomBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:closet_right_bottom")
	public static final Block block = null;
	public ClosetRightBottomBlock(FnafModModElements instance) {
		super(instance, 347);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("closet_right_bottom");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				ClosetRightBottomBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ClosetRightBottomBlockIsPlacedByProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ClosetRightBottomOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
