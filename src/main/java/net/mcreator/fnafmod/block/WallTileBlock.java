...
public class WallTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:wall_tile")
	public static final Block block = null;
	public WallTileBlock(FnafModModElements instance) {
		super(instance, 6);
	}
