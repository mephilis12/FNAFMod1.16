	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FnafModMod.LOGGER.warn("Failed to load dependency x for procedure ToyChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FnafModMod.LOGGER.warn("Failed to load dependency y for procedure ToyChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FnafModMod.LOGGER.warn("Failed to load dependency z for procedure ToyChicaOnEntityTickUpdate!");
			return;
		}
		...
		if ((!((world instanceof World) ? ((World) world).isDaytime() : false))) {
			if ((entity instanceof ToyChicaEntity.CustomEntity)) {
				...
				if (world instanceof ServerWorld) {
					Entity entityToSpawn = new NightimeToyChicaEntity.CustomEntity(NightimeToyChicaEntity.entity, (World) world);
