...
public class PassiveFredbearOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public PassiveFredbearOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 221);
	}
