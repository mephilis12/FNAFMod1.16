...
import net.mcreator.fnafmod.procedures.SittingSpringBonnieOnInitialEntitySpawnProcedure;
import net.mcreator.fnafmod.itemgroup.FNAFMobsItemGroup;
import net.mcreator.fnafmod.entity.renderer.SittingSpringBonnieRenderer;
...
public class SittingSpringBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("sitting_spring_bonnie").setRegistryName("sitting_spring_bonnie");
	public SittingSpringBonnieEntity(FnafModModElements instance) {
		super(instance, 124);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SittingSpringBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4810998, -12582330, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("sitting_spring_bonnie_spawn_egg"));
	}
