...
public class WhiteRedWallTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:white_red_wall_tile")
	public static final Block block = null;
	public WhiteRedWallTileBlock(FnafModModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_red_wall_tile");
		}
