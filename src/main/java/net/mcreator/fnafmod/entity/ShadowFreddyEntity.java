...
import net.mcreator.fnafmod.entity.renderer.ShadowFreddyRenderer;
...
public class ShadowFreddyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("shadow_freddy").setRegistryName("shadow_freddy");
	public ShadowFreddyEntity(FnafModModElements instance) {
		super(instance, 204);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14942183, -16777216, new Item.Properties().group(FNAFMobsItemGroup.tab))
