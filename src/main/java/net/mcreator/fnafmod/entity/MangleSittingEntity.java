...
import net.mcreator.fnafmod.entity.renderer.MangleSittingRenderer;
...
public class MangleSittingEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("mangle_sitting").setRegistryName("mangle_sitting");
	public MangleSittingEntity(FnafModModElements instance) {
		super(instance, 282);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MangleSittingRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -4810998, -12582330, new Item.Properties().group(null)).setRegistryName("mangle_sitting_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				MangleSittingOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MangleSittingOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
