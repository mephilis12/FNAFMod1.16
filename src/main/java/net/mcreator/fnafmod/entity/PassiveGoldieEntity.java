...
import net.mcreator.fnafmod.entity.renderer.PassiveGoldieRenderer;
...
public class PassiveGoldieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("passive_goldie").setRegistryName("passive_goldie");
	public PassiveGoldieEntity(FnafModModElements instance) {
		super(instance, 158);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PassiveGoldieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -9682156, -16777216, new Item.Properties().group(null)).setRegistryName("passive_goldie_spawn_egg"));
	}
