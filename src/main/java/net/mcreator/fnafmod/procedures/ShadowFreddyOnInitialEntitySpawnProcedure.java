...
public class ShadowFreddyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public ShadowFreddyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 235);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure ShadowFreddyOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure ShadowFreddyOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof ShadowFreddyEntity.CustomEntity)) {
