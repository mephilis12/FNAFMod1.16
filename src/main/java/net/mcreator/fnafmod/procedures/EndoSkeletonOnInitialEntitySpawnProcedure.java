...
public class EndoSkeletonOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public EndoSkeletonOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 227);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure EndoSkeletonOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure EndoSkeletonOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof EndoSkeletonEntity.CustomEntity)) {
