...
import net.mcreator.fnafmod.entity.renderer.PassiveSpringBonnieRenderer;
...
public class PassiveSpringBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("passive_spring_bonnie").setRegistryName("passive_spring_bonnie");
	public PassiveSpringBonnieEntity(FnafModModElements instance) {
		super(instance, 161);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PassiveSpringBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9682156, -16777216, new Item.Properties().group(null))
				.setRegistryName("passive_spring_bonnie_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SpringBonnieItem.block, (int) (1)));
		}
