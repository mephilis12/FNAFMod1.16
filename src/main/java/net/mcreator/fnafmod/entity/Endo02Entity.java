...
import net.mcreator.fnafmod.entity.renderer.Endo02Renderer;
...
public class Endo02Entity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("endo_02").setRegistryName("endo_02");
	public Endo02Entity(FnafModModElements instance) {
		super(instance, 233);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6776939, -14606047, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("endo_02_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				Endo02OnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
