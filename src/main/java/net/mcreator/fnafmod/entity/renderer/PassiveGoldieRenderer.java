...
@OnlyIn(Dist.CLIENT)
public class PassiveGoldieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PassiveGoldieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFreddy(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/goldenfreddypassivetexture.png");
					}
				};
			});
		}
