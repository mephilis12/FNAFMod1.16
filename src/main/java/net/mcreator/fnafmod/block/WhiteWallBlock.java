...
public class WhiteWallBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:white_wall")
	public static final Block block = null;
	public WhiteWallBlock(FnafModModElements instance) {
		super(instance, 23);
	}
