...
public class ToyChicaOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public ToyChicaOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 239);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure ToyChicaOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure ToyChicaOnInitialEntitySpawn!");
			return;
		}
