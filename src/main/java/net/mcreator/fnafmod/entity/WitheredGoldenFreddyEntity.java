...
import net.mcreator.fnafmod.procedures.WitheredGoldenFreddyOnInitialEntitySpawnProcedure;
...
import net.mcreator.fnafmod.entity.renderer.WitheredGoldenFreddyRenderer;
...
public class WitheredGoldenFreddyEntity extends FnafModModElements.ModElement {
	...
	public WitheredGoldenFreddyEntity(FnafModModElements instance) {
		super(instance, 203);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4810998, -16777216, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("withered_golden_freddy_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 9001);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(GoldenFreddyPlushieBlock.block));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				WitheredGoldenFreddyOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
