...
@OnlyIn(Dist.CLIENT)
public class SittingWitheredBonnieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SittingWitheredBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSittingWitheredBonnie(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/witheredbonniewool.png");
					}
				};
			});
		}
