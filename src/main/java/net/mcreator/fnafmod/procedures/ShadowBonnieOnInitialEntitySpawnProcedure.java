...
public class ShadowBonnieOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public ShadowBonnieOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 242);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure ShadowBonnieOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure ShadowBonnieOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof ShadowBonnieEntity.CustomEntity)) {
