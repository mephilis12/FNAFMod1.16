...
public class SittingFredbearOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public SittingFredbearOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 219);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure SittingFredbearOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure SittingFredbearOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof SittingFredbearEntity.CustomEntity)) {
