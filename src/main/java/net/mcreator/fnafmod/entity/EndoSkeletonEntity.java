...
import net.mcreator.fnafmod.entity.renderer.EndoSkeletonRenderer;
...
public class EndoSkeletonEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("endo_skeleton").setRegistryName("endo_skeleton");
	public EndoSkeletonEntity(FnafModModElements instance) {
		super(instance, 178);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EndoSkeletonRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6776939, -14606047, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("endo_skeleton_spawn_egg"));
	}
