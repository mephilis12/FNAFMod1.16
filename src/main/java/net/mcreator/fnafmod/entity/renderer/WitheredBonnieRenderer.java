...
public class WitheredBonnieRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WitheredBonnieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWitheredBonnie(), 0.5f) {
					@Override
