...
import net.mcreator.fnafmod.procedures.SittingFredbearOnInitialEntitySpawnProcedure;
import net.mcreator.fnafmod.itemgroup.FNAFMobsItemGroup;
import net.mcreator.fnafmod.entity.renderer.SittingFredbearRenderer;
...
public class SittingFredbearEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("sitting_fredbear").setRegistryName("sitting_fredbear");
	public SittingFredbearEntity(FnafModModElements instance) {
		super(instance, 137);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SittingFredbearRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2375875, -10087826, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("sitting_fredbear_spawn_egg"));
	}
