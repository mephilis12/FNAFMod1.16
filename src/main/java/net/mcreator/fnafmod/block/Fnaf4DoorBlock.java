...
public class Fnaf4DoorBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_4_door")
	public static final Block block = null;
	public Fnaf4DoorBlock(FnafModModElements instance) {
		super(instance, 311);
	}
