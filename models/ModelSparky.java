...
public static class ModelSparky extends EntityModel<Entity> {
	...
	public ModelSparky() {
		...
		Head.setTextureOffset(50, 11).addBox(-3.0F, -4.0F, -6.0F, 6.0F, 2.0F, 2.0F, 0.0F, false);
		Head.setTextureOffset(58, 15).addBox(-1.0F, -4.5F, -6.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(72, 23).addBox(3.0F, -9.0F, -3.0F, 2.0F, 8.0F, 3.0F, 0.0F, false);
		Head.setTextureOffset(86, 25).addBox(-5.0F, -9.0F, -3.0F, 2.0F, 7.0F, 3.0F, 0.0F, false);
		...
		Jaw.setTextureOffset(65, 39).addBox(-2.5F, -0.5F, -5.0F, 5.0F, 2.0F, 1.0F, 0.0F, false);
		...
		RightArm.setTextureOffset(91, 45).addBox(-2.01F, -2.0F, 0.0F, 3.0F, 10.0F, 0.0F, 0.0F, false);
		...
		LeftLeg.setTextureOffset(73, 46).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 13.0F, 4.0F, 0.0F, false);
	}
