...
import net.mcreator.fnafmod.procedures.SittingWitheredBonnieOnInitialEntitySpawnProcedure;
import net.mcreator.fnafmod.procedures.SittingWitheredBonnieOnEntityTickUpdateProcedure;
import net.mcreator.fnafmod.entity.renderer.SittingWitheredBonnieRenderer;
...
public class SittingWitheredBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("sitting_withered_bonnie").setRegistryName("sitting_withered_bonnie");
	public SittingWitheredBonnieEntity(FnafModModElements instance) {
		super(instance, 289);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SittingWitheredBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4810998, -12582330, new Item.Properties().group(null))
				.setRegistryName("sitting_withered_bonnie_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				SittingWitheredBonnieOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SittingWitheredBonnieOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
