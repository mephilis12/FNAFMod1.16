...
public class RedBlackTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:red_black_tile")
	public static final Block block = null;
	public RedBlackTileBlock(FnafModModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_black_tile");
		}
