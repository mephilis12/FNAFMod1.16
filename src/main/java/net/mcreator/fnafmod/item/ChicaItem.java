...
public class ChicaItem extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:chica")
	public static final Item block = null;
	public ChicaItem(FnafModModElements instance) {
		super(instance, 173);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				ChicaRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
