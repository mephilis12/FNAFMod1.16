...
public class Endo02OnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public Endo02OnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 243);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure Endo02OnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure Endo02OnInitialEntitySpawn!");
			return;
		}
