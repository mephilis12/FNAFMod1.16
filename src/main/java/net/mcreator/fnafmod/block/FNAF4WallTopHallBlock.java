...
public class FNAF4WallTopHallBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_4_wall_top_hall")
	public static final Block block = null;
	public FNAF4WallTopHallBlock(FnafModModElements instance) {
		super(instance, 341);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fnaf_4_wall_top_hall");
		}
