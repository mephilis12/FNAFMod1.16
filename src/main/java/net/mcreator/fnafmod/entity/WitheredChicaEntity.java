...
import net.mcreator.fnafmod.procedures.WitheredChicaOnEntityTickUpdateProcedure;
...
public class WitheredChicaEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("withered_chica").setRegistryName("withered_chica");
	public WitheredChicaEntity(FnafModModElements instance) {
		super(instance, 199);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7304690, -3355648, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("withered_chica_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				WitheredChicaOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				WitheredChicaOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
