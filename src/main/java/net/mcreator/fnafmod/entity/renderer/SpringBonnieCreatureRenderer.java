...
@OnlyIn(Dist.CLIENT)
public class SpringBonnieCreatureRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SpringBonnieCreatureEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSpring_Bonnie(), 0.5f) {
					@Override
	...
	public static class ModelSpring_Bonnie extends EntityModel<Entity> {
		...
		public ModelSpring_Bonnie() {
			...
			Head.setTextureOffset(28, 73).addBox(-1.5F, -5.3912F, -4.8F, 3.0F, 1.0F, 1.0F, 0.1F, false);
