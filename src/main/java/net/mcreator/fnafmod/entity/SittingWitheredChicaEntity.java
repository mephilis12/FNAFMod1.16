...
import net.mcreator.fnafmod.procedures.SittingWitheredChicaOnInitialEntitySpawnProcedure;
import net.mcreator.fnafmod.procedures.SittingWitheredChicaOnEntityTickUpdateProcedure;
import net.mcreator.fnafmod.entity.renderer.SittingWitheredChicaRenderer;
...
public class SittingWitheredChicaEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("sitting_withered_chica").setRegistryName("sitting_withered_chica");
	public SittingWitheredChicaEntity(FnafModModElements instance) {
		super(instance, 292);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SittingWitheredChicaRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4810998, -12582330, new Item.Properties().group(null))
				.setRegistryName("sitting_withered_chica_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("world", world);
				SittingWitheredChicaOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SittingWitheredChicaOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
