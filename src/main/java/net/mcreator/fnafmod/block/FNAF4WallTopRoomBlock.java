...
public class FNAF4WallTopRoomBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_4_wall_top_room")
	public static final Block block = null;
	public FNAF4WallTopRoomBlock(FnafModModElements instance) {
		super(instance, 340);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fnaf_4_wall_top_room");
		}
