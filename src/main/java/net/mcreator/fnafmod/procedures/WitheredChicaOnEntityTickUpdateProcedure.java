	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure WitheredChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FnafModMod.LOGGER.warn("Failed to load dependency x for procedure WitheredChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FnafModMod.LOGGER.warn("Failed to load dependency y for procedure WitheredChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FnafModMod.LOGGER.warn("Failed to load dependency z for procedure WitheredChicaOnEntityTickUpdate!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure WitheredChicaOnEntityTickUpdate!");
			return;
		}
			...
			if (((entity.getPersistentData().getDouble("FNAFTimer")) == 0)) {
				if ((entity instanceof WitheredChicaEntity.CustomEntity)) {
					...
					if (world instanceof ServerWorld) {
						Entity entityToSpawn = new SittingWitheredChicaEntity.CustomEntity(SittingWitheredChicaEntity.entity, (World) world);
