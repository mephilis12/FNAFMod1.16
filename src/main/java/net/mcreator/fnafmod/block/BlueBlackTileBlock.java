...
public class BlueBlackTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:blue_black_tile")
	public static final Block block = null;
	public BlueBlackTileBlock(FnafModModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_black_tile");
		}
