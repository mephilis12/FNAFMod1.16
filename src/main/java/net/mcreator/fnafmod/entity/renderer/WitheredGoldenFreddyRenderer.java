...
@OnlyIn(Dist.CLIENT)
public class WitheredGoldenFreddyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WitheredGoldenFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelWitheredGoldenFreddy(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/witheredgoldenfreddywool.png");
					}
				};
			});
		}
	...
	public static class ModelWitheredGoldenFreddy extends EntityModel<Entity> {
		...
		public ModelWitheredGoldenFreddy() {
			...
			Head.setTextureOffset(0, 0).addBox(4.0F, -10.0F, 0.0F, 3.0F, 4.0F, 0.0F, 0.0F, false);
