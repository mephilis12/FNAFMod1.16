...
public class SittingWitheredChicaOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public SittingWitheredChicaOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 303);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure SittingWitheredChicaOnInitialEntitySpawn!");
			return;
		}
