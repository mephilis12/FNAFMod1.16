...
import net.mcreator.fnafmod.procedures.BBEntityDiesProcedure;
import net.mcreator.fnafmod.itemgroup.FNAFMobsItemGroup;
import net.mcreator.fnafmod.entity.renderer.BBRenderer;
...
public class BBEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.5f)).build("bb").setRegistryName("bb");
	public BBEntity(FnafModModElements instance) {
		super(instance, 210);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BBRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -2087900, -9321766, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("bb_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BBEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				BBOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
