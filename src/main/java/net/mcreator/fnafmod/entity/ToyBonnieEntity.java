...
import net.mcreator.fnafmod.procedures.ToyBonnieOnInitialEntitySpawnProcedure;
import net.mcreator.fnafmod.procedures.ToyBonnieEntityDiesProcedure;
...
import net.mcreator.fnafmod.entity.renderer.ToyBonnieRenderer;
...
public class ToyBonnieEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("toy_bonnie").setRegistryName("toy_bonnie");
	public ToyBonnieEntity(FnafModModElements instance) {
		super(instance, 208);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ToyBonnieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12536345, -4780787, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("toy_bonnie_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ToyBonnieEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("world", world);
				ToyBonnieOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
