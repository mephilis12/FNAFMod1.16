...
public class DoorButtonOffBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:door_button_off")
	public static final Block block = null;
	public DoorButtonOffBlock(FnafModModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("door_button_off");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				DoorButtonOffOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
