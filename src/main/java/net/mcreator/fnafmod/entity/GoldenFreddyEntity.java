...
public class GoldenFreddyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("golden_freddy").setRegistryName("golden_freddy");
	public GoldenFreddyEntity(FnafModModElements instance) {
		super(instance, 46);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GoldenFreddyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4810998, -16777216, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("golden_freddy_spawn_egg"));
	}
