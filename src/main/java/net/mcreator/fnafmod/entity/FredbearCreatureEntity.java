...
import net.mcreator.fnafmod.entity.renderer.FredbearCreatureRenderer;
import net.mcreator.fnafmod.FnafModModElements;

@FnafModModElements.ModElement.Tag
public class FredbearCreatureEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("fredbear_creature").setRegistryName("fredbear_creature");
	public FredbearCreatureEntity(FnafModModElements instance) {
		super(instance, 136);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FredbearCreatureRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("fredbear_creature_spawn_egg"));
	}
