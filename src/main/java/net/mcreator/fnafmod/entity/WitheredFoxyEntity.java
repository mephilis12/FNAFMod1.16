...
import net.mcreator.fnafmod.procedures.WitheredFoxyEntityDiesProcedure;
...
import net.mcreator.fnafmod.entity.renderer.WitheredFoxyRenderer;
...
public class WitheredFoxyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("withered_foxy").setRegistryName("withered_foxy");
	public WitheredFoxyEntity(FnafModModElements instance) {
		super(instance, 202);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3855830, -11652589, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("withered_foxy_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				WitheredFoxyEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
