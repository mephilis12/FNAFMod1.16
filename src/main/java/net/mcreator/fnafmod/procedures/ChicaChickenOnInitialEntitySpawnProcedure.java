...
public class ChicaChickenOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public ChicaChickenOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 216);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FnafModMod.LOGGER.warn("Failed to load dependency entity for procedure ChicaChickenOnInitialEntitySpawn!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FnafModMod.LOGGER.warn("Failed to load dependency world for procedure ChicaChickenOnInitialEntitySpawn!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		IWorld world = (IWorld) dependencies.get("world");
		if ((entity instanceof ChicaChickenEntity.CustomEntity)) {
