...
public class GoldenFreddyRenderer {
			...
			RenderingRegistry.registerEntityRenderingHandler(GoldenFreddyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgolden_freddy(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fnaf_mod:textures/goldenfreddytexture.png");
					}
				};
			});
		}
	...
	public static class Modelgolden_freddy extends EntityModel<Entity> {
		...
		public Modelgolden_freddy() {
			...
			setRotationAngle(LeftLeg, -1.5708F, -0.2182F, 0.0F);
			...
			LeftLeg.setTextureOffset(20, 47).addBox(-2.5F, 14.1F, -5.5F, 5.0F, 2.0F, 2.0F, 0.0F, false);
			RightLeg = new ModelRenderer(this);
			RightLeg.setRotationPoint(-2.0F, 1.0F, 0.0F);
			Body.addChild(RightLeg);
			setRotationAngle(RightLeg, -1.5708F, 0.2182F, 0.0F);
