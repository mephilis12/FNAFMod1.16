...
public class FNAF3WallTileBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:fnaf_3_wall_tile")
	public static final Block block = null;
	public FNAF3WallTileBlock(FnafModModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fnaf_3_wall_tile");
		}
