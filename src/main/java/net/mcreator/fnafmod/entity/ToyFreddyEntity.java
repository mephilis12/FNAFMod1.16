...
public class ToyFreddyEntity extends FnafModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("toy_freddy").setRegistryName("toy_freddy");
	public ToyFreddyEntity(FnafModModElements instance) {
		super(instance, 207);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7906275, -7269099, new Item.Properties().group(FNAFMobsItemGroup.tab))
				.setRegistryName("toy_freddy_spawn_egg"));
	}
