...
public class BlackWallBlock extends FnafModModElements.ModElement {
	@ObjectHolder("fnaf_mod:black_wall")
	public static final Block block = null;
	public BlackWallBlock(FnafModModElements instance) {
		super(instance, 9);
	}
