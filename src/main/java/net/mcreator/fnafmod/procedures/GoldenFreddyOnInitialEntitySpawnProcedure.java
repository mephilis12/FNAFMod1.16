...
public class GoldenFreddyOnInitialEntitySpawnProcedure extends FnafModModElements.ModElement {
	public GoldenFreddyOnInitialEntitySpawnProcedure(FnafModModElements instance) {
		super(instance, 214);
	}
